...
These messages are now on your queue. You can validate this through Broker Manager by inspecting the queue. Now receive the messages using a flow consumer as outlined in detail in previous tutorials.
