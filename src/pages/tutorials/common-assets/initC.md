...
Finally a session is needed to actually connect to the Solace Event Broker. This is accomplished by creating a properties array and connecting the session.
...
At this point your client is connected to the Solace Event Broker. You can use Broker Manager to view the client connection and related details.
